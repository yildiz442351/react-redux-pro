    ...
    <div className='flex items-center justify-between bg-indigo-600 text-white px-4 py-3'>
        ...
        <div className='flex items-center gap-5'>
            <div className='text-black'>
                <select onChange={e => dispatch(sotringDataFunc(e.target.value))} className='h-10 rounded-lg' name="" id="">
            ...
            <div onClick={ () => dispatch(modalFunc())} className='bg-indigo-800 w-10 h-10 rounded-full flex items-center jusgtify-center cursor-pointer'>
               <MdPostAdd size={24}/>
            </div>
        </div>
    </div>
